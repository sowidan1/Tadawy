                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('assets/img/icons/unicons/calendar.png') }}"
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="p-0 m-0">
                                            ...
                                            <li class="d-flex mb-4 pb-1">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="{{ asset('assets/img/icons/unicons/artificial-intelligence (1).png') }}"
                                                        alt="User" class="rounded" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex mb-4 pb-1">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="{{ asset('assets/img/icons/unicons/incubator - Copy.png') }}"
                                                        alt="User" class="rounded" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="{{ asset('assets/img/icons/unicons/health.png') }}"
                                                        alt="User" class="rounded" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
